...
export class InitDb1666041545502 implements MigrationInterface {
  name = 'InitDb1666041545502';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "username" citext NOT NULL, "password" text NOT NULL, "salt" text, "firstName" citext, "lastName" citext, "email" citext NOT NULL, "active" boolean NOT NULL DEFAULT true, "resetToken" uuid, "resetTokenExp" TIMESTAMP, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
